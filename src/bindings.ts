...
export type Router = {
	...
	sharedModified: number | null,
		 ...
		 */
		export_server: (serverId: string, mode: ExportMode, dest: string | null) => Promise<string>,
		...
		get_lan_address: () => Promise<string | null>,
