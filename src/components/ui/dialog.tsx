		...
		<DialogPortal>
			...
			>
				{isMobile && (
					<div
						aria-hidden
						className="absolute top-2 left-1/2 h-1 w-10 -translate-x-1/2 rounded-full bg-zinc-700"
					/>
				)}
				{children}
				{showCloseButton && (
